        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="col-sm-offset-1">
                    ...
                    <?php
                        $a = array('method' =>'post');
                        echo form_open_multipart('users/User_profile/user_photo',$a);
                    ?>
                ...
                <div class="panel-body" style="margin: 30px 0;">
                    <?php
                        $a = array('method' =>'post');
                        echo form_open_multipart('users/User_profile/update_user_info',$a);
                    ?>
                    <fieldset>
                            ...
                            <div class="row single_field">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="nick_name" id="short_name" value="<?php echo $user_info['nick_name']; ?>" type="text">
                                </div>
                            </div>
                            ...
                            <div class="row single_field">
                                ...
                                <div class="col-md-8">
                                    <input type="radio" name="sex" value="male" <?php echo ($user_info['sex'] == 'male' ? 'checked' : ''); ?>> Male
                                    <input type="radio" name="sex" value="female" <?php echo ($user_info['sex'] == 'female' ? 'checked' : ''); ?> > Female
                                </div>
                            </div>
                            ...
                            <div class="row single_field">
                                ...
                                <div class="col-md-8">
                                    <?php echo $user_info['logout_time']; ?>
                                </div>
                            </div>
