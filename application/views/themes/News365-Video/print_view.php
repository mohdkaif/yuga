...
<body>
    ...
    <div class="printpage">	
    	...
    	<div class="news">
                    <?php
                    if ($videos) {
                        echo '<img  src="http://img.youtube.com/vi/' . $videos . '/0.jpg" align="left" width="400" title="'.@$website_title.'" alt="'.@$website_title.'" />';
                    } else {
                      echo'<img src="'.$bu.'/uploads/'.$image.'" align="left" width="400" title="'.@$website_title.'" alt="'.@$website_title.'" />';
                    }
                    ?>   
    	...
    	<div class="footer">
            <div class="fc_left">
                <a href="<?php echo $bu;?>">
                <img src="<?php echo $bu.@$website_logo; ?>" height="35" title="<?php echo @$website_title;?>" alt="<?php echo @$website_title;?>" />
                </a>
