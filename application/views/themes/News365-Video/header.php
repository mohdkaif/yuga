         ...
         OneSignal.push(function() {
           OneSignal.init({
             ...
             promptOptions: {
              ...
              actionMessage: "पाएं युगान्तर प्रवाह की ताज़ा ख़बरों के अलर्ट और अपडेट्स हमारे नोटिफिकेशन के साथ रहें अपडेट।आप इसे ब्राउसर सेटिंग में जाकर कभी भी बदल सकते हैं।",
