                    ...
                    <div class="col-sm-12 col-md-12">
                        ...
                        <div class="post-style2 archive-post-style-2">
                             <?php if($value->image!=NULL){?>
                                ...
                                <a href="<?php echo base_url() . '/Story/'.$value->page .'/' . $slugrow['slug'] . '/' . $exploded_SLUG; ?>"><img src="<?php echo base_url() . 'uploads/thumb/' . $value->image; ?>" alt="" ></a>
                           ...
                           <?php } else{?>
                            ...
                            <div class="post-style2-detail">
                                <h4><a href="<?php echo base_url()  . '/Story/'.$value->page.'/' . $slugrow['slug'] . '/' . $exploded_SLUG; ?>" title=""><?php echo @$value->title; ?></a></h4>
                                <div class="date">
                                    <ul>
