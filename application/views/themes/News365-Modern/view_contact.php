            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="contact-title-2">
                        <h2><?php echo display('contact')?></h2>
            ...
            <div class="row">
                <div class="col-sm-4"> 
                    <div class="contact-address-2"> <!-- Address -->
                        ...
                        <?php if (isset($contact_page[0]->address)) echo @$contact_page[0]->address; ?>
                    </div>
                </div>
                    ...
                    <div class="contact-form-area-2">
                        ...
                        ?>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <span class="input">
                                        <input class="input_field" type="text" id="input-1" name="first_name" required="1">
                                    ...
                                    <span class="input">
                                        <input class="input_field" type="text" id="input-2" name="last_name" required="1">
                                    ...
                                    <span class="input">
                                        <input class="input_field" type="email" id="input-3" required="1" name="email">
                                    ...
                                    <span class="input">
                                        <input class="input_field" type="text" id="input-4" required="1" name="subject">
                                ...
                                <div class="col-sm-6">
                                    <span class="input">
                                        <textarea class="input_field" id="message" required="1" name="message"></textarea>
