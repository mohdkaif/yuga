...
#------------------------------------------------
    public function get_all_category() {
        $query = $this->db->query("SELECT categories.category_id,categories.slug,categories.category_name,max_archive_settings.max_archive FROM categories LEFT JOIN max_archive_settings ON  categories.category_id=max_archive_settings.category_id");
        $result = $query->result();
