<?php 
  ...
  <div class="ap-settings-wrapper wrap">
   ...
   <ul class="ap-settings-tabs">
    ...
    <li><a href="javascript:void(0)" id="morewp-settings" class="ap-tabs-trigger"><?php _e('More WordPress Resources','accesspress-anonymous-post');?></a></li>
  </ul>
  ...
  <div class="metabox-holder">
    <div id="optionsframework" class="postbox" style="float: left;">
      ...
      <?php 
        ...
        * More WordPress Tab
        * */
       include_once('boards/more-wordpress.php');
       ?>
       <?php
       /**
        * Nonce field
